...
define('VIRTUAL_PATH', 'http://www.dohmang.com/ITC250/wn17/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/johgil45/dohmang.com/ITC250/wn17/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'jgilme01@seattlecentral.edu'); # Email of site support
...
$nav1['news/'] = "News~A portal to recent news";
